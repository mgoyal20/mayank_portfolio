...
# Map our "interests" to Google Places types or keywords
INTEREST_TO_QUERY = {
...
def get_live_pois(city: str, interests: list, limit: int = 25) -> List[Dict]:
    # Query Google Places Text Search for a city's POIs based on interests. Cached on disk.
    if not API_KEY:
        return []
    ...
    for interest in interests:
        ...
        mapping = INTEREST_TO_QUERY.get(interest, {})
